package xyz.ipiepiepie.task_11.util;
...
public class JTableUtil {
    ...
    public static int[][] readIntMatrixFromJTable(JTable table) throws ParseException {
        try {
            ...
            return (int[][]) Arrays.stream(matrix).map(ArrayUtil::toPrimitive).toArray((n) -> new int[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static int[] readIntArrayFromJTable(JTable table) throws ParseException {
        try {
            return ArrayUtil.toPrimitive(readArrayFromJTable(table, Integer.class, Integer::parseInt, false, 0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static double[][] readDoubleMatrixFromJTable(JTable table) throws ParseException {
        try {
            Double[][] matrix = readMatrixFromJTable(table, Double.class, JTableUtil::parseDouble, false, 0.0);
            return (double[][]) Arrays.stream(matrix).map(ArrayUtil::toPrimitive).toArray((n) -> new double[n][]);
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
    ...
    public static double[] readDoubleArrayFromJTable(JTable table) throws ParseException {
        try {
            return ArrayUtil.toPrimitive(readArrayFromJTable(table, Double.class, JTableUtil::parseDouble, false, 0.0));
        } catch (JTableUtilsException impossible) {
        }
        return null;
    }
